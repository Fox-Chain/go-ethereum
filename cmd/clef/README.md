...
The signer will generate a new private key, encrypt it according to [web3 keystore spec](https://github.com/fox-chain/wiki/wiki/Web3-Secret-Storage-Definition) and store it in the keystore directory.  
...
#### Arguments
  - content type [string]: type of signed data
     ...
     - `application/clique`: [clique](https://github.com/fox-chain/EIPs/issues/225) headers
...
#### Sign data
   Signs a chunk of structured data conformant to [EIP-712](https://github.com/fox-chain/EIPs/blob/master/EIPS/eip-712.md) and returns the calculated signature.
...
| Clef UI| https://github.com/fox-chain/clef-ui| Golang/QT-based| :+1:| :+1:| :x:| :+1:| :+1:| :x: |  :+1: (approve tx only)|
